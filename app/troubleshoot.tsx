...
const styles = StyleSheet.create({
  ...
  subtitle: { color: palette.textMuted, fontSize: 10.5, lineHeight: 14, marginTop: 3 },
  ...
  answerCopy: { flex: 1 },
  answerTitle: { color: palette.text, fontWeight: '800', fontSize: 14 },
  answerText: { color: palette.textMuted, fontSize: 12, lineHeight: 18, marginTop: 3 },
