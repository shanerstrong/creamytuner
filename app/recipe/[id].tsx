  ...
  return (
    <Screen contentStyle={styles.screenContent}>
      ...
      <GlassCard style={styles.detailCard}>
        ...
        {tab === 'nutrition' ? <View style={styles.nutritionDetails}><DetailMetric label="Calories" value={`${recipe.nutrition.calories}`} /><DetailMetric label="Protein" value={`${recipe.nutrition.protein} g · ${Math.round((recipe.nutrition.protein / 50) * 100)}% DV`} /><DetailMetric label="Carbohydrates" value={`${recipe.nutrition.carbs} g`} /><DetailMetric label="Sugar" value={`${recipe.nutrition.sugar} g`} /><DetailMetric label="Fat" value={`${recipe.nutrition.fat} g`} /><DetailMetric label="Fiber" value={`${recipe.nutrition.fiber} g · ${Math.round((recipe.nutrition.fiber / 28) * 100)}% DV`} /></View> : null}
