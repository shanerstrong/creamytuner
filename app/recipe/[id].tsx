...
export default function RecipeDetailsScreen() {
  ...
  const confirmDelete = () => Alert.alert('Delete recipe?', 'This removes the recipe from this device.', [{ text: 'Cancel', style: 'cancel' }, { text: 'Delete', style: 'destructive', onPress: async () => { await deleteRecipe(recipe.id); router.replace('/(tabs)/recipes'); } }]);
  return (
...
const styles = StyleSheet.create({
  ...
  padded: { paddingHorizontal: spacing.md }, actions: { flexDirection: 'row', marginTop: spacing.sm, marginHorizontal: spacing.md, borderWidth: 1, borderColor: palette.border, borderRadius: radii.md, overflow: 'hidden' },
