...
const styles = StyleSheet.create({
  ...
  entryHeader: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', gap: spacing.xs, marginTop: spacing.sm }, entryLabel: { color: palette.text, fontSize: 13, lineHeight: 18, fontWeight: '900', letterSpacing: 0.8 }, entryHint: { color: palette.textMuted, fontSize: 12, lineHeight: 17 },
  precisionToggle: { flexDirection: 'row', borderRadius: radii.pill, borderWidth: 1, borderColor: palette.border, overflow: 'hidden' }, precisionOption: { minWidth: 64, minHeight: 38, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 8 }, precisionOptionActive: { backgroundColor: 'rgba(174,134,255,0.2)' }, precisionText: { color: palette.textMuted, fontSize: 12, fontWeight: '800' }, precisionTextActive: { color: palette.white },
